              ...
              <div className="sm:col-span-4">
                ...
                <div className="mt-2">
                  <input
                    ...
                    className="block p-2 w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-sky-600 sm:text-sm sm:leading-6"
                  />
                  {errors.phone?.message && <p className="mt-2 text-sm text-red-400">{errors.phone.message}</p>}
                </div>
              </div>
            </div>
          </motion.div>
              ...
              <div className="sm:col-span-3">
                ...
                <div className="mt-2">
                  <select
                    ...
                    className="block p-2 w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 focus:ring-2 focus:ring-inset focus:ring-sky-600 sm:max-w-xs sm:text-sm sm:leading-6"
                  >
        ...
        {currentStep === 2 && (
          <>
            ...
            <motion.div
              ...
              transition={{ duration: 0.3, ease: "easeInOut" }}
            >
              <h2 className="mt-10 mb-5 text-base font-semibold leading-7 text-gray-900 underline">Personal Information</h2>
            ...
            <motion.div
              ...
              transition={{ duration: 0.3, ease: "easeInOut" }}
            >
              <h2 className="mt-10 text-base font-semibold leading-7 text-gray-900 underline">Address</h2>
              {/* <p className="mt-1 text-sm leading-6 text-gray-600">Address where you can receive mail.</p> */}
